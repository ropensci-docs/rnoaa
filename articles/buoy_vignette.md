...
This vignette covers NOAA buoy data from the National Buoy Data Center.
The main function to get data is `buoy`, while `buoys` can be used to
...
With `buoy` you can get data for a particular dataset, buoy id, year,
and datatype.
